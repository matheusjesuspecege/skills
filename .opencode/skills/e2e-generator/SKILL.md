...
- Os arquivos de teste devem ser salvos na pasta **tests/e2e/<projeto>** dentro da pasta com o nome do caso de uso representando um substantivo, e o cenario de teste representando o que realmente é o caso de uso ex: **tests/e2e/<projeto>/checkout/classificar-tipo-pedido/classificar-tipo-pedido.spec.ts**.
...
- Os page objects devem ser salvos na pasta **tests/e2e/page-objects**.
- As funções auxiliares devem ser salvas na pasta **tests/e2e/helpers** no arquivo representando o macro da feature para centralizar a logica da feature.
...
2. Analise os cenários BDD associados ao caso de uso e identifique os passos Given, When e Then.
3. Para cada cenário BDD, crie um cenário de teste correspondente usando a estrutura definida.
4. Organize os cenários de teste em um arquivo de teste, seguindo as melhores práticas de organização e nomenclatura.
5. Salve o arquivo de teste na raiz do projeto dentro da pasta **tests/e2e**, garantindo que o nome do arquivo seja descritivo e relacionado ao caso de uso.
6. Informe o usuário sobre a criação do arquivo de teste e forneça um resumo dos cenários de teste gerados.

---

## Resultado Esperado

- Um arquivo de teste é criado na pasta **tests/e2e** com o nome do caso de uso e do cenário de teste, seguindo o padrão de nomenclatura estabelecido.
